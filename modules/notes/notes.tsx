...
const Notes = () => {
  ...
  return (
    <div className="py-5 container m-auto max-w-[1250px] px-10">
      <NotesHead />
      <div className="flex h-screen bg-white rounded-xl mt-10">
        {/* Sidebar */}
        ...
        {/* Content Area */}
        <div className="w-3/4 p-6 overflow-y-scroll no-scrollbar max-h-[100vh]">
          <div className="bg-gray-100 rounded-xl border p-6">
            ...
            <div className="flex justify-center">
              {!isAddingNote ? (
                <div
                  ...
                  className="bg-white p-2 mb-4 rounded-lg cursor-pointer shadow-md w-3/4"
                >
                  Take a note...
                </div>
              ) : (
                <div className="bg-white  mb-4 rounded-xl shadow-md w-3/4">
                  {newNote.image && (
            ...
            <div className="grid grid-cols-3 gap-4">
              {content[activeTab]?.map((item) => (
                <div
                  key={item.id}
                  className="bg-white shadow-md rounded-lg cursor-pointer h-fit"
            ...
            <div className="flex justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-transparent text-black rounded hover:bg-gray-300"
                >
                  Close
                </button>
              </div>
